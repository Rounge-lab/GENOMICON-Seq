...
### Upload files
# .stat.csv table
table <-read.csv("A2.HPV16.stats.csv", header = TRUE, sep = "\t")

#chromosome.csv table
table_chr <- read.csv("A2.HPV16.chromosome.csv", header = TRUE, sep = "\t")

#fastq_stat.csv
fastq <- read.csv("A2.fastq_stats.csv",sep = "\t")
...
write.csv(file="A2_compiled_stats.csv", stats_merged, row.names = FALSE)
